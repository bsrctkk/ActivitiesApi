    ...
    public partial class createdatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ActivityDetails_ActivityCategories_ActivityCategoryId",
                        column: x => x.ActivityCategoryId,
                        principalTable: "ActivityCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ActivityDetails_Places_PlaceId",
                        column: x => x.PlaceId,
                        principalTable: "Places",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ActivityDetails_Tickets_TicketId",
                        column: x => x.TicketId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityDetails_ActivityCategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityDetails_PlaceId",
                table: "ActivityDetails",
                column: "PlaceId");

            migrationBuilder.CreateIndex(
                name: "IX_ActivityDetails_TicketId",
                table: "ActivityDetails",
                column: "TicketId");
